...
function getArtistByIndex(array, index) {
    const artist = array[index].name
    const id = array[index].id
    return `The artist at index ${id} is ${artist}.`
  }
...
function addArtist(array, id, name, years, genre, nationality, bio){
  ...
  console.log(addArtist(artists, "20", "Jonathan Canola", "1994", "Web Design", "Italian", "I am a Robot and I do Robot things."))
